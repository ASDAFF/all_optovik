            ...
            <div class="row">
                <div class="col-6 col-md-24">
                    <div class="block block_h2">
                        <a href="" title="" class="block__item" style="background-image: url('/assets/img/slider/img-1.jpg')"></a>
                        <a href="" title="" class="block__item" style="background-image: url('/assets/img/slider/img-1.jpg')"></a>
                    </div>
                </div>
                <div class="col-12 col-md-24">
                    <div class="row">
                        <div class="col-24">
                            <div class="block">
                                <a href="" title="" class="block__item" style="background-image: url('/assets/img/slider/img-2.jpg')"></a>
                                <a href="" title="" class="block__item" style="background-image: url('/assets/img/slider/img-2.jpg')"></a>
                            </div>
                        </div>
                        <div class="col-24">
                            <div class="row">
                                <div class="col-12 col-md-24">
                                    <div class="block">
                                        <a href="" title="" class="block__item" style="background-image: url('/assets/img/slider/img-4.jpg')"></a>
                                        <a href="" title="" class="block__item" style="background-image: url('/assets/img/slider/img-4.jpg')"></a>
                                    </div>
                                </div>
                                <div class="col-12 col-md-24">
                                    <div class="block">
                                        <a href="" title="" class="block__item" style="background-image: url('/assets/img/slider/img-5.jpg')"></a>
                                        <a href="" title="" class="block__item" style="background-image: url('/assets/img/slider/img-5.jpg')"></a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-6 col-md-24">
                    <div class="block block_h2">
                        <a href="" title="" class="block__item" style="background-image: url('/assets/img/slider/img-3.jpg')"></a>
                        <a href="" title="" class="block__item" style="background-image: url('/assets/img/slider/img-3.jpg')"></a>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid page__index__about">
        <div class="container">
            <div class="page__index__about__title">
                <span>о компании  All-optovik</span>
            </div>
            ...
            <div class="page__index__about__btn">
                <a href="" title="" class="core__btn" data-fancybox="modal" data-src="#core__modal__add">Добавить свою компанию</a>
            </div>
            <div class="core__line_bg"></div>
        </div>
    </div>
